...
EFI_GUID  mTestNamespaceGuid1 = {
  0x3b389299, 0xabaf, 0x433b, { 0xa4, 0xa9, 0x23, 0xc8, 0x44, 0x02, 0xfc, 0xad }
};
EFI_GUID  mTestNamespaceGuid2 = {
  0x4c49a3aa, 0xbcb0, 0x544c, { 0xb5, 0xba, 0x34, 0xd9, 0x55, 0x13, 0x0d, 0xbe }
};
EFI_GUID  mTestNamespaceGuid3 = {
  0x5d5ab4bb, 0xcdc1, 0x655d, { 0xc6, 0xcb, 0x45, 0xea, 0x66, 0x24, 0x1e, 0xcf }
};

#define  TEST_AUTH_VAR_NAME  L"DummyAuthVar"
EFI_GUID  mTestAuthNamespaceGuid = {
  0xb6c5a2c6, 0x3ece, 0x4b9b, { 0x8c, 0xc8, 0x96, 0xd8, 0xd9, 0xca, 0xd3, 0x4e }
};
  ...
  )
{
  ...
  Value  = 0x56;
  Status = gRT->SetVariable (
                  L"MustHaveAttrWildcardNoLockVar1573",
                  &mTestNamespaceGuid1,
                  EFI_VARIABLE_BOOTSERVICE_ACCESS,
                  sizeof (Value),
                  &Value
  ...
  //
  Status = gRT->SetVariable (
                  L"MustHaveAttrWildcardNoLockVar1234",
                  &mTestNamespaceGuid1,
                  (EFI_VARIABLE_NON_VOLATILE  | EFI_VARIABLE_BOOTSERVICE_ACCESS),
                  sizeof (Value),
                  &Value
  ...
  //
  Status = gRT->SetVariable (
                  L"MustHaveAttrWildcardNoLockVar5612",
                  &mTestNamespaceGuid1,
                  (EFI_VARIABLE_NON_VOLATILE  | EFI_VARIABLE_BOOTSERVICE_ACCESS | EFI_VARIABLE_RUNTIME_ACCESS),
                  sizeof (Value),
                  &Value
